  ...
  const docs = [
    {
      ...
      description:
        'Set up EasyAuth in your project within minutes with our quick start guide.',
      link: '#',
    },
    {
      title: 'API Reference',
      description:
        'Complete API documentation with examples and SDKs for popular frameworks.',
      link: '#',
    },
    {
      title: 'Best Practices',
      description:
        'Learn security best practices and authentication patterns from our experts.',
      link: '#',
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {docs.map((doc, index) => (
            ...
            >
              <h3 className="text-2xl font-bold mb-3 text-white group-hover:text-gray-300 transition">
                {doc.title} →
              </h3>
