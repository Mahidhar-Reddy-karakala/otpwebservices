...
export const Home = () => {
  return (
    <section
      id="Home"
      className="min-h-screen flex items-center justify-center px-4 py-30 bg-black border-t border-gray-800"
    >
      <div className="relative max-w-5xl mx-auto text-center z-10">
        <div className="inline-block mb-6 px-4 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm hover:bg-white/10 smooth-transition">
          <span className="text-xs md:text-sm text-white/80">
            ✨ The next-gen authentication platform
          </span>
        </div>
        ...
        <p className="text-lg md:text-xl text-white/60 mb-12 max-w-3xl mx-auto leading-relaxed">
          EasyAuth is a modern authentication platform that helps developers
          integrate secure login systems in minutes. Focus on building great
          products while we handle security.
        </p>
